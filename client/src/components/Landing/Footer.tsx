                    ...
                    <div className="xl:flex xl:gap-6 xl:h-56 md:flex md:gap-8 md:h-60">
                        ...
                        <div className="text-white mt-3">
                            ...
                            <ul className="underline underline-offset-1 text-white text-opacity-50 mt-3 xl:h-16 xl:flex xl:flex-col xl:justify-between xl:gap-4 flex gap-5">
                                <li>
                                    <a  className="flex" href="https://www.facebook.com/tharsisUNI/posts/pfbid02pA7u8gSwQE88FHb1uNbrANWH8P66uhURapE8e1htAyB4e63oCVzrRFxfosEPvv2hl" target="_blank">
                                    How is the space vehicle designed at UNI that has surprised NASA
                                    </a>
                                </li>
                                <li>
                                    <a  className="flex" href="https://www.facebook.com/tharsisUNI/posts/pfbid035fuEdE4zQBS8VQSYMs5J2jLPAJUS5u7mE34otr51zHTgPdd1AAPX3aiCXVqQnTcDl" target="_blank">
